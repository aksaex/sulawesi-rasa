...
export default function RegisterPage() {
  ...
  return (
    <main className="min-h-[100dvh] flex items-center justify-center px-4 md:px-6 relative overflow-hidden">
      {/* BACKGROUND IMAGE - Selaras dengan Login */}
      <Image 
        src="/image/hero.png" 
        alt="Rempah Sulawesi"
        priority
        ...
        <div className="bg-white/85 backdrop-blur-2xl border border-white/50 rounded-[2rem] md:rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.2)] overflow-hidden">
          ...
          <div className="p-8 md:p-10 pb-4 md:pb-6 text-center">
            <h1 className="text-3xl md:text-4xl font-serif text-[oklch(0.25_0.06_35)] leading-tight">
              Gabung <span className="italic opacity-60">Sulawesi</span> Rasa
            </h1>
            <p className="text-[oklch(0.45_0.08_35)] text-xs md:text-sm mt-3 font-medium">
              Daftarkan UMKM Anda dalam 1 menit
            </p>
          </div>
          ...
          <div className="px-7 md:px-10 pb-8 md:pb-10 space-y-5 md:space-y-6">
            ...
            <form action={handleAction} className="space-y-4 md:space-y-5">
              ...
              <div className="space-y-1.5 md:space-y-2">
                ...
                <div className="relative group">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 size-4 text-[oklch(0.45_0.08_35)] group-focus-within:text-[oklch(0.32_0.10_25)] transition-colors" />
                  <Input 
                    name="name" 
                    required 
                    placeholder="Andi Sultan" 
              ...
              <Button 
                disabled={loading} 
                className="w-full h-12 md:h-14 rounded-xl md:rounded-2xl bg-[oklch(0.32_0.10_25)] hover:bg-[oklch(0.25_0.06_35)] text-[oklch(0.92_0.04_75)] font-bold text-[10px] md:text-xs uppercase tracking-widest transition-all shadow-lg active:scale-[0.98] disabled:opacity-70 mt-2"
              >
                {loading ? "Menyinkronkan..." : "Daftar Sekarang"}
              </Button>
            </form>
            ...
            <div className="pt-4 border-t border-[oklch(0.85_0.05_75)] text-center">
              <p className="text-[9px] md:text-[10px] uppercase tracking-widest font-bold text-[oklch(0.45_0.08_35)]">
                Sudah Punya Akun?{" "}
                <Link href="/login" className="text-[oklch(0.58_0.18_45)] hover:underline ml-1">
                  Masuk di Sini
                </Link>
              </p>
            </div>
